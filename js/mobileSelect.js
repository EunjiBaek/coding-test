          ...
          value: function init() {
            ...
            if (
              ...
              if (
                ...
                (this.ensureBtn =
                  this.mobileSelect.querySelector(".ms-ensure")),
                (this.cancelBtn =
                  this.mobileSelect.querySelector(".ms-cancel")),
                (this.grayLayer =
                ...
                t.initValue &&
                  t.triggerDisplayValue &&
                  (this.trigger.innerText = t.initValue),
                this.setStyle(t),
                (this.isPC = l.checkIsPC()),
                (this.isCascade = this.checkCascade()),
                this.isCascade && this.initCascade(),
                t.initValue && (this.initPosition = this.getPositionByValue()),
              ...
              this.isCascade
                  ...
                  ensureBtn: {
                    ...
                    fn: function fn() {
                      ...
                      _this.hide(),
                        _this.optionHeight ||
                          (_this.optionHeight =
                            _this.mobileSelect.querySelector(
                              "li"
                            ).offsetHeight);
                      var e = "";

                      for (var o = 0; o < _this.wheelList.length; o++) {
                        o == _this.wheelList.length - 1
                          ? (e += _this.getInnerText(o))
                          : (e +=
                              _this.getInnerText(o) + _this.config.connector);
                      }

                      t.triggerDisplayValue && (_this.trigger.innerText = e),
                        (_this.curIndexArr = _this.getIndexArr()),
                        (_this.curValue = _this.getCurValue()),
                        (s = (i = _this.config).callback) == null ||
                          s.call(i, _this.curIndexArr, _this.curValue, _this),
                        (r = (n = _this.config).onChange) == null ||
                          r.call(n, _this.curValue, _this.curIndexArr, _this);
                    },
                  },
                  trigger: {
                    event: "click",
                ...
                this.isPC &&
                  (this.eventHandleMap.panel.event = [
                    "mousedown",
                    "mousemove",
                    "mouseup",
                  ]),
        ...
        },
        {
          ...
          value: function getPositionByValue() {
            ...
            if (this.isJsonType) {
              ...
              return s.reduce(function (o, g) {
                ...
                var a =
                  r == null
                    ? void 0
                    : r.findIndex(function (d) {
                        return d[t.value] == g;
                      });
                return (
                  o.push(a < 0 ? 0 : a),
                  (r = (u = r[a]) == null ? void 0 : u[t.childs]),
                  o
                );
              }, []);
            }
            ...
            return s.reduce(function (r, o, g) {
              var u, d;
              var a =
                (d = (u = _this2.wheelsData[g]) == null ? void 0 : u.data) ==
                null
                  ? void 0
                  : d.findIndex(function (m) {
                      return m == o;
                    });
          ...
          value: function registerEvents(t) {
            ...
            var _loop = function _loop() {
              ...
              typeof i.event == "string"
                ? _this3[e]["".concat(t, "EventListener")](i.event, i.fn, {
                    passive: !1,
                  })
            ...
            for (var _o = 0; _o <= t; _o++) {
              n =
                _o == 0
                  ...
                  : (r = n == null ? void 0 : n[s.childs]) == null
                  ? void 0
                  : r[e[_o]];
            }
          ...
          value: function fixRowStyle() {
            ...
            if (
              ...
              this.initColWidth.forEach(function (i, s) {
                _this4.wheelList[s].style.width =
                  ((i / e) * 100).toFixed(2) + "%";
              });
              return;
            }
            ...
            if (this.isCascade)
              for (var s = 0; s < this.wheelList.length; s++) {
                ...
                n &&
                  t.push(
                    ((_t$push = {}),
                    _defineProperty(_t$push, i.id, n[i.id]),
                    _defineProperty(_t$push, i.value, n[i.value]),
                    _t$push)
                  );
              }
              ...
              for (var _s3 = 0; _s3 < this.curDistance.length; _s3++) {
                t.push(
                  this.wheelsData[_s3].data[
                    this.getIndex(this.curDistance[_s3])
                  ]
                );
              }
            else
          ...
          value: function touch(t) {
            ...
            switch (t.type) {
              ...
              case "mousedown":
                (s.style.transition = "none 0s ease-out"),
                  (this.startY = Math.floor(
                    t instanceof TouchEvent ? t.touches[0].clientY : t.clientY
                  )),
                  (this.preMoveY = this.startY),
                  t.type === "mousedown" && (this.enableClickStatus = !0);
                break;
              ...
              case "mousemove":
                if (
                  (t.preventDefault(),
                  t.type === "mousemove" && !this.enableClickStatus)
                )
                  break;
                ...
                if (
                  ...
                  if (p != 2) {
                    ...
                    C <= 2 * this.optionHeight &&
                      ...
                      this.movePosition(s, this.curDistance[n]),
                      (o = (r = this.config).transitionEnd) == null ||
                        o.call(r, this.getIndexArr(), this.getCurValue(), this),
                      (a = (g = this.config).onTransitionEnd) == null ||
                        a.call(
                          g,
                          this.getCurValue(),
                          this.getIndexArr(),
                  ...
                  this.updateCurDistance(s, n),
                    ...
                    this.curDistance[n] > 2 * this.optionHeight
                      ...
                      : this.curDistance[n] < this.oversizeBorder &&
                        (this.curDistance[n] = this.oversizeBorder),
                    this.movePosition(s, this.curDistance[n]),
                    (d = (u = this.config).transitionEnd) == null ||
                      d.call(u, this.getIndexArr(), this.getCurValue(), this),
                    (v = (m = this.config).onTransitionEnd) == null ||
                      v.call(m, this.getCurValue(), this.getIndexArr(), this);

                t.type === "mouseup" && (this.enableClickStatus = !1),
